    ...
    <section className="relative w-full h-[700px] overflow-hidden py-20">
      ...
      <div className="absolute inset-0 z-10 flex items-center justify-center flex-col">
        ...
        <div className="absolute inset-x-0 bottom-0 z-20">
          <Marquee
            speed={80}
            className="absolute z-30 bottom-0 bg-[#d26403] w-full text-white p-3 font-medium text-2xl"
          >
            <p>
              New Arrivals: [Through The Silent Forest] | Special Discount on
              Memberships - Sign up today for exclusive offers and early access
