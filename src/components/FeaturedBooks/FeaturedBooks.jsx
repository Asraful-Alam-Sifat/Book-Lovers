    ...
    <div className="container mx-auto py-15">
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 sm:gap-x-3 mt-7  justify-around gap-5 sm:place-items-center">
        {featuredBooks.map((book) => (
          <div key={book.id} className="w-[500px] sm:w-[300px] md:w-[250px] lg:w-[250px] xl:w-[300px] bg-base-100 p-5 rounded-xl shadow-lg border-3 border-gray-200 hover:border-blue-500 transition-all duration-400 flexflex-col items-center">
